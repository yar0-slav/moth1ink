...
const Main = ({children, router}) => {
    ...
    return (
        <Box as="main" className="background-color--change"
             data-page={router.asPath == '/' ? 'homepage' : router.asPath.slice(1)} pb={8}>
            <Head>
            ...
            <Container maxW="container.lg" pt={14}>
                <CookieConsent
                    ...
                    declineButtonStyle={{background: "rgb(0 0 0 / 0%)", color: "white", padding: '8px 20px', borderRadius: "30px"}}
                    onDecline={handleDeclineCookie}
                    onAccept={handleAcceptCookie}
                >
                    This site uses analytical cookies for improving user experience. Analytical cookies are used for gathering information how the visitors interact with the site. They cannot be used to directly identify a user. By using our site you agree with using cookies.
                </CookieConsent>
                {children}
            </Container>
